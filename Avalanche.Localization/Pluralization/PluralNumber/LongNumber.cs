...
public struct LongNumber : IDecimalNumber
{
    /// <summary>Zero singleton</summary>
    static IPluralNumber _zero = new LongNumber(0L, new TextNumber("0".AsMemory(), numberStyles: NumberStyles.Integer));
    ...
    public IPluralNumber N => Value < 0L ? new LongNumber(-Value, (TextNumber)AsText.N) : this;
    ...
    /// <summary>Create long value</summary>
    /// <param name="value"></param>
    /// <param name="text">(optional) value as text</param>
    public LongNumber(long value, TextNumber? text = default!)
    {
        this.Value = value;
        this.text = text;
    }
    /// <summary></summary>
    public IPluralNumber Modulo(int modulo) => new LongNumber(Value % (long)modulo);
