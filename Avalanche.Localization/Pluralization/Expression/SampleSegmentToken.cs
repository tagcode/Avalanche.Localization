...
public struct SampleSegmentToken : IToken
{
    /// <summary>Create token</summary>
    public SampleSegmentToken() { }
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<SampleSegmentToken> c) { c.Visit(this); return true; } else return false; }
