...
public struct ExpressionToken : IToken
{
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<ExpressionToken> c) { c.Visit(this); return true; } else return false; }
