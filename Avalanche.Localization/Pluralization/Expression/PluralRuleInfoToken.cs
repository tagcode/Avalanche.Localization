...
public struct PluralRuleInfoToken : IToken
{
    /// <summary>Create token</summary>
    public PluralRuleInfoToken() { }
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<PluralRuleInfoToken> c) { c.Visit(this); return true; } else return false; }
