...
public struct ExpressionSegmentToken : IToken
{
    /// <summary>Create token</summary>
    public ExpressionSegmentToken() { }
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<ExpressionSegmentToken> c) { c.Visit(this); return true; } else return false; }
